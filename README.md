...
<body>
    ...
    <div class="card">
      ...
      <form id="bookingForm" action="https://webto.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8&orgId=00DNS00000IaWdK" method="POST">
        ...
        <div>
          ...
          <input id="check_in" name="00NNS00001imwfl" type="date">
        </div>
        <div>
          <label for="check_out">Check Out Date</label>
          <input id="check_out" name="00NNS00001imPSL" type="date">
        </div>
  ...
  <script>
    document.getElementById('bookingForm').addEventListener('submit', function() {
      ...
      inDate.value = formatDate(inDate);
      outDate.value = formatDate(outDate);
    });
  </script>
</body>
</html>
