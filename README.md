...
<body>
  <div class="wrap">
    <div class="card">
      ...
      <form id="hotel-form" action="https://webto.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8&orgId=00DNS00000IaWdK" method="POST">
...
<script>
document.getElementById("hotel-form").addEventListener("submit", function(){
  function formatDate(isoDate) {
    if (!isoDate) return "";
    let parts = isoDate.split("-");
    return parts[2] + "/" + parts[1] + "/" + parts[0];
  }
  let ci = document.getElementById("check_in");
  let co = document.getElementById("check_out");
  ci.value = formatDate(ci.value);
  co.value = formatDate(co.value);
});
</script>
</body>
</html>
